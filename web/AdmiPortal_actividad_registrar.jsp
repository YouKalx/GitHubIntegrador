                    ...
                    <div class="container" id="advanced-search-form">
                        ...
                        <form action="ActividadesControl" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control"  name="dia" placeholder="">
                            </div>
                            <div class="form-group">
                                <label for="country">Hora del evento</label>
                                <input type="text" class="form-control" name="hora" placeholder="">
                            </div>  
