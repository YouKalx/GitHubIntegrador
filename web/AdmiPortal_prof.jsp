...
"https://media.geeksforgeeks.org/wp-content/uploads/20221210183321/7.png"
		...
		<div class="main">
			...
			<div class="box-container">
				...
				<div class="box box1">
                                     <a href="EmpleadoGui.jsp"></a>
					<div class="text">
						<h2 class="topic-heading">1</h2>
						<a class="topic" href="AdmiPortal_prof_registrar.jsp"><h4>Registrar nuevo profesor</h4></a>
					</div>
				</div>
				...
				<div class="box box2">
					<div class="text">
						<h2 class="topic-heading">2</h2>
                                                <a class="topic"><h4>Listar profesores</h4></a>
                                                <form action="ProfesorControl" method="post"><input class="botonlistar"type="submit" name="acc" value="Listar">
					</div>
				</div>
				...
				<div class="box box3">
					<div class="text">
						<h2 class="topic-heading">3</h2>
                                                <a class="topic" href="AdmiPortal_prof_buscar.jsp"><h4>Buscar / Modificar / Eliminar profesor</h4></a>
					</div>
				</div>
