...
<html lang="es">
    ...
    <body class="main-layout">
                        ...
                        <div class="container">
                            <div class="carousel-caption">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="text_img">
                                            <figure><img src="images/english2.png" alt="#"/></figure>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="container">
                            <div class="carousel-caption">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="text_img">
                                            <figure><img src="images/english3.png" alt="#"/></figure>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="three_box">
            <div class="container">          
                <div class="titlepage">
                    <h3>PUEDES UNIRTE A LAS CLASES DESDE ESTOS DISPOSITIVOS</h3>
                </div>
                <div class="row">

                    <div class="col-md-4">
                        <div class="box_text">
                            <i><img src="images/thr.png" alt="30px"/></i>
                            <h3>Computadora</h3>
                            <p></p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="box_text">
                            <i><img src="images/thr1.png" alt="30px"/></i>
                            <h3>Laptop</h3>
                            <p></p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="box_text">
                            <i><img src="images/thr2.png" alt="30px"/></i>
                            <h3>Tablet</h3>
        ...
        <div class="laptop">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="titlepage">
                            <p>APROVECHA EL CIBER WOW EN "ENGLISH HOUSE"</p>
                            <h2>20% de descuento!</h2>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="laptop_box">
                            <figure><img src="images/english1.png" alt="#"/></figure>
                        </div>
                    </div>
                </div>
            </div>
