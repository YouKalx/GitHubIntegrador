<%-- 
    Document   : AlumPortal_Reemb
    Created on : 4 jul. 2023, 16:51:04
    Author     : ShuKalx
--%>
            ...
            <div class="main" style="background: #e4f4fd">
                <div class="box-container">
                    ...
                    <div class="container" id="advanced-search-form" style="margin: auto; float: right; float: left" >
                        <br><h1 style="text-align: center;">Información sobre la Solicitud: Reembolso</h1><br>
                        <h3 style="margin-left: 5%; margin-right: 5% ; color: black"></h3>
                        <h2><n>Costo:</n></h2>
                        <h3 style="margin-left: 5%;margin-right: 5%; color: black">S/. 25.00</h3><br>
                        <h2><n>Pasos a seguir</n></h2>
                        <h3 style="margin-left: 5%;margin-right: 5%; color: black" >
                            -Ingresar los datos solicitados<br>
                            -Adjuntar boleta o voucher de pago escaneado por el cual solicitas el reembolso.<br>
                            -Adjuntar tu documento de identidad escaneado.<br>
                            -En el campo “Detalle de solicitud” es importante que indiques el motivo del reembolso, así como, el tipo de reembolso que deseas.<br>
