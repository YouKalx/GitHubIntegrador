<%-- 
    Document   : AlumPortal_TraSol_mensaje
    Created on : 4 jul. 2023, 16:44:55
    Author     : ShuKalx
--%>
                    ...
                    <div class="container" id="advanced-search-form">
                        ...
                        <div class="card">
                            <div class="card" style="width: 18rem;">
                                ...
                                <a href="AlumPortal_TraSol.jsp" class="boton" ><input type="submit" name="acc" value="Volver al Trámites / Solicitudes" style="background-color: green; border-radius: 8px; font-size: 20px; width: 100%; color:white"/></a>
                            </div> 
                        </div>
                    </div>
                </div>
