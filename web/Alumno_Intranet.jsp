<html lang="es">
    <head>
        ...
        <!-- site metas -->
        <title>English House/Intranet/Estudiante</title>
                        ...
                        <div class="card" style="border-radius: 1rem;">
                            <div class="row g-0">
                                <div class="col-md-6 col-lg-5 d-none d-md-block">
                                    <img src="https://images.pexels.com/photos/4861351/pexels-photo-4861351.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
                                         alt="login form" class="img-fluid" style="border-radius: 1rem 0 0 1rem;" />
                                </div>
                                <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                    <div class="card-body p-4 p-lg-5 text-black">

                                        <form method="post" action="AlumnoControl"   name="f1" >
                                            <h2>Intranet Estudiante</h2>
                                            ...
                                            <div class="form-outline mb-4">
                                                ...
                                                <input type = "text" name="usualu" class="form-control form-control-lg" />  
                                            </div>
