                ...
                <div class="box-container">
                    ...
                    <div class="container" id="advanced-search-form">
                        ...
                        <form action="HorarioControl" method="post">
                            ...
                            <div class="form-group">
                                <label for="last-name">Turno de horario</label>
                                <input type="text" class="form-control" name="tur" placeholder="">
                            </div>
                            <div class="form-group">
                                <label for="country">Hora de inicio</label>
                                <input type="text" class="form-control" name="hoini" placeholder="">
                            </div>
                            <div class="form-group">
                                <label for="number">Hora de fin</label>
                                <input type="text" class="form-control"  name="hofin" placeholder="">
                            </div>
                            <div class="form-group">
                                <label for="country">¿Clases Lunes?</label>
                                <input type="text" class="form-control" name="lun" placeholder="">
                            </div>  
                            <div class="form-group">
                                <label for="country">¿Clases Martes?</label>
                                <input type="text" class="form-control" name="mar" placeholder="">
                            </div>  
                            <div class="form-group">
                                <label for="country">¿Clases Miércoles?</label>
                                <input type="text" class="form-control" name="mie" placeholder="">
                            </div>  
                            <div class="form-group">
                                <label for="country">¿Clases Jueves?</label>
                                <input type="text" class="form-control" name="jue" placeholder="">
                            </div>  
                            <div class="form-group">
                                <label for="country">¿Clases Viernes?</label>
                                <input type="text" class="form-control" name="vie" placeholder="">
                            </div>  
