<%-- 
    Document   : AlumPortal_Perfil
    Created on : 4 jul. 2023, 16:39:44
    Author     : ShuKalx
--%>
                    ...
                    <div class="nav-upper-options">
                        ...
                        <div class="option2 nav-option">
                            <img src=
                                 ...
                                 class="nav-img"
                                 alt="articles">
                            <a class="nav-link" href="AlumPortal_Perfil.jsp"><h5><form action="AlumnoControl" method="post"><input class="nav-link" style="border: none; background-color: transparent; color: white; " type="submit" name="acc" value="Perfil"></form></h5></a>
                        </div>
