<%-- 
    Document   : AlumPortal_TS_Certificado
    Created on : 4 jul. 2023, 16:40:43
    Author     : ShuKalx
--%>
            ...
            <div class="main" style="background: #e4f4fd">
                <div class="box-container">
                    ...
                    <div class="container" id="advanced-search-form" style="margin: auto; float: right; float: left" >
                        <br><h1 style="text-align: center;">Información sobre la Solicitud: Certificado</h1><br>
                        ...
                        <h3 style="margin-left: 5%;margin-right: 5%; color: black" >
                            ...
                            -En un documento adjunta una fotografía tuya actual tamaño pasaporte a color, de frente (tipo DNI)<br>
