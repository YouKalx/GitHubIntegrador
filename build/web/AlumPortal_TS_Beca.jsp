<%-- 
    Document   : AlumPortal_TS_Beca
    Created on : 4 jul. 2023, 16:40:22
    Author     : ShuKalx
--%>
            ...
            <div class="main" style="background: #e4f4fd">
                <div class="box-container">
                    ...
                    <div class="container" id="advanced-search-form" style="margin: auto; float: right; float: left" >
                        <br><h1 style="text-align: center;">Información sobre el Trámite: Beca</h1><br>
                        <h3 style="margin-left: 5%; margin-right: 5% ; color: black">Beneficio dirigido a alumnos continuos de English House.
                            El porcentaje de descuento en las cuotas aplica desde el 10% hasta 50% previa evaluación.</h3>
                        <h2><n>Costo:</n></h2>
                        <h3 style="margin-left: 5%;margin-right: 5%; color: black">S/. 21.00</h3><br>
                        <h2><n>Pasos a seguir</n></h2>
                        <h3 style="margin-left: 5%;margin-right: 5%; color: black" >
                            -Ingresar los datos solicitados<br>
                            -Subir archivo mostrando el SISFOH.<br>
