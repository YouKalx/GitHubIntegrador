			...
			<div class="box-container">
                            ...
                            <form action="AdministradorControl" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Codigo" name="cod">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="ape" placeholder="DNI">
                                </div>
                                <div class="form-group">
                                    <label for="number">DNI del administrador </label>
                                    <input type="text" class="form-control" type="text"  name="dni">
                                </div>
                                <div class="form-group">
