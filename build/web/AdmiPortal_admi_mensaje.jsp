			...
			<div class="box-container">
                    ...
                    <div class="card">
                     ...
                     <div class="card" style="width: 18rem;">
                                ...
                                <a href="1_AdmiPortalPrincipal.jsp" class="boton" ><input type="submit" name="acc" value="Volver al Portal" style="background-color: green; border-radius: 8px; font-size: 20px; width: 100%; color:white"/></a>
                            </div> 
                      </div>
