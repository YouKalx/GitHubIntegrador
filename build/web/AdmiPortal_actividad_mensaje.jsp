                    ...
                    <div class="container" id="advanced-search-form">
                        ...
                        <div class="card">
                            ...
                            <div class="card" style="width: 18rem;">
                                ...
                                <a href="AdmiPortal_actividad.jsp" class="boton" ><input type="submit" name="acc" value="Volver al Portal" style="background-color: green; border-radius: 8px; font-size: 20px; width: 100%; color:white"/></a>
                            </div> 
                        </div>
