<%-- 
    Document   : ProPortal_Eventos
    Created on : 4 jul. 2023, 16:45:21
    Author     : ShuKalx
--%>
                    ...
                    <div class="nav-upper-options">
                        ...
                        <div class="nav-option option5">
                            <img src=
                                 ...
                                 class="nav-img"
                                 alt="blog">
                           <a class="nav-link" href="ProPortal_Eventos.jsp"><h5><form action="ActividadesControl" method="post"><input class="nav-link" style="border: none; background-color: transparent; color: white" type="submit" name="acc" value="Eventos Doc"></form></h5></a>
                        </div>
