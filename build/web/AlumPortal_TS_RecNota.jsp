<%-- 
    Document   : AlumPortal_TS_RecNota
    Created on : 4 jul. 2023, 16:42:12
    Author     : ShuKalx
--%>
            ...
            <div class="main" style="background: #e4f4fd">
                <div class="box-container">
                    ...
                    <div class="container" id="advanced-search-form" style="margin: auto; float: right; float: left" >
                        <br><h1 style="text-align: center;">Información sobre el Trámite: Rectificación de Nota</h1><br>
                        ...
                        <h3 style="margin-left: 5%;margin-right: 5%; color: black" >
                            ...
                            -En un documento detallar lo sucedido y agregar una imagen (opcional) como prueba )<br>
