                ...
                <div class="box-container">
                    ...
                    <div class="box box1">
                        <div class="text">
                            ...
                            <a class="topic" href="AdmiPortal_notas_registrar.jsp"><h4>Registrar </h4></a>
                        </div>
                    </div>
                    ...
                    <div class="box box2">
                        <div class="text">
                            ...
                            <a class="topic"><h4>Listar</h4></a>
                            <form action="NivelControl" method="post"><input class="botonlistar"type="submit" name="acc" value="Listar">
                                </div>
                                </div>
                                ...
                                <div class="box box3">
                                    <div class="text">
                                        ...
                                        <a class="topic" href="AdmiPortal_nivel_buscar.jsp"><h4>Buscar / Modificar / Eliminar</h4></a>
                                    </div>
                                </div>
