			...
			<div class="box-container">
                            ...
                            <form action="AlumnoControl" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="ape" placeholder="">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="country">Celular de alumno</label>
                                    <input type="text" class="form-control" name="cel" placeholder="">
                                </div>
                                <div class="form-group">
                                    <label for="number">Nivel del alumno </label>
                                    <input type="text" class="form-control" name="niv" placeholder="" >
                                </div>
                                <div class="form-group">
                                    <label for="age">Crea un usuario</label>
                                    <input type="text" class="form-control" name="usu" placeholder="">
                                </div>
                                <div class="form-group">
